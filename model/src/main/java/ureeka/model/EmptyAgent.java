...
public class EmptyAgent implements Agent {

	public boolean addValidationError(Property<Object> property,
			ValidationMessage message, Object[] parameters, AgentChain chain) {
		if (property == null) throw new NullPointerException("Passed property was null");
		if (chain == null) throw new NullPointerException("Passed chain was null");
		return chain.next(this).addValidationError(property, message, parameters, chain);
	}
	...
	public boolean propertyValidationErrorEvent(Property<Object> property,
		...
		if (property == null) throw new NullPointerException("Passed property was null");
		if (chain == null) throw new NullPointerException("Passed chain was null");
		return chain.next(this).propertyValidationErrorEvent(property, chain);		
	}

	public boolean propertyValueChangedEvent(Property<Object> property, AgentChain chain) {
		if (property == null) throw new NullPointerException("Passed property was null");
		if (chain == null) throw new NullPointerException("Passed chain was null");
		return chain.next(this).propertyValueChangedEvent(property, chain);
	}
